...
# Import and setup API endpoints for Google Ads and Meta
try:
    from api_endpoints import setup_api_endpoints
    setup_api_endpoints(app)
    logger.info("✅ API endpoints for Google Ads and Meta loaded successfully")
except ImportError as e:
    logger.warning(f"⚠️ Could not load API endpoints: {e}")
except Exception as e:
