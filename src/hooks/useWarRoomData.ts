...
export function useDataMode() {
  ...
  console.log('🔍 DATA MODE DEBUG:', {
    envUseMock,
    envType: typeof envUseMock,
    localStorageUseMock,
    localStorageType: typeof localStorageUseMock,
    timestamp: new Date().toISOString()
  });
  
  // Convert to boolean - handle both string and boolean env vars
  const isMock = envUseMock === 'true' || envUseMock === true || 
                 localStorageUseMock === 'true';

  console.log('🎯 FINAL DATA MODE:', isMock ? 'MOCK' : 'LIVE');
