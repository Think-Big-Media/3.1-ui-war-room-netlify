...
// Component to format AI messages with proper line breaks and bullet points
    ...
    <div className="space-y-1">
      {lines.map((line, index) => {
        ...
        if (trimmedLine.endsWith(':') && !trimmedLine.startsWith('•')) {
          return (
            <div key={index} className="font-semibold text-gray-900 mt-2 first:mt-0">
              {trimmedLine}
            </div>
          );
        }
        ...
        // Handle ASCII bars and visual elements (preserve monospace)
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      >
        ...
        {isExpanded && (
          <div
            className="bg-white/10 backdrop-blur-xl rounded-t-2xl overflow-hidden border-b border-white/20 h-[520px]"
          >
            {/* Chat History State */}
            {chatState === 'history' && (
              <div className="flex flex-col h-full">
                ...
                <div className="flex-1 overflow-y-scroll overscroll-contain p-3" style={{ scrollbarWidth: 'thin', maxHeight: '360px' }}>
            ...
            {chatState === 'chat' && (
              <div className="flex flex-col h-full">
                ...
                {/* Messages Area */}
                <div className="flex-1 p-4 overflow-y-scroll overscroll-contain" style={{ scrollbarWidth: 'thin', maxHeight: '400px' }}>
                  <div className="space-y-2">
                    {currentMessages.map((msg) => (
                      ...
                      >
                        <div className="flex flex-col items-start max-w-[85%]">
                          <div
                            className={`px-3 py-2 text-base leading-tight ${
                              msg.isUser 
